...
def generate_vertical_comparison_charts(data_by_interval, intersection_name, output_dir):
    ...
    try:
        ...
        metrics = [
            ...
            {'column': 'pass_speed', 'name': '车均通过速度', 'ylabel': '通过速度 (km/h)'},
            {'column': 'no_stop_pass_speed', 'name': '车均不停车通过速度', 'ylabel': '不停车通过速度 (km/h)'},
...
def get_date_ranges():
    ...
    # 格式: (启用标志, 开始时间, 结束时间)
    time_periods = [
        (True, '2026-03-02 00:00:00', '2026-03-02 23:59:59'),  # 2月2日全天
        (True, '2026-03-09 00:00:00', '2026-03-09 23:59:59'),  # 时间段2
        (True, '2026-03-16 00:00:00', '2026-03-16 23:59:59'), # 时间段3
        (True, '2026-03-23 00:00:00', '2026-03-23 23:59:59'), # 时间段4
