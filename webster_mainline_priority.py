...
def brute_force_optimal_cycle(L_total, phase_data, T=0.25):
    ...
    # 【绿波带约束 1】强制拉高公共周期下限，确保主干道有足够绿信比
    for C in range(120, 181):
        G = C - L_total
        if G <= 0:
            continue
