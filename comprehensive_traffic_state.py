...
# ================= 全局配置区 =================
TARGET_DATE_WD = '2026-04-21'
DAY_TYPE_WD = '工作日'

TARGET_DATE_WE = '2026-04-26'
DAY_TYPE_WE = '非工作日'
...
# ================= 状态推演修正区 =================
# 【核心修正】基于物理实际通行能力重新标定阈值 (单位: 5分钟切片)
TRAFFIC_STATE_THRESHOLDS = {
    '极低流量': {'max_flow': 150, 'description': '夜间低峰，流量稀少'},           # 对应 < 450 pcu / 15min
    '平峰流量': {'min_flow': 150, 'max_flow': 280, 'description': '日常平峰，流量适中'}, # 对应 450 - 840 pcu / 15min
    '高峰流量': {'min_flow': 280, 'description': '真正早晚高峰，流量拥挤'}         # 对应 > 840 pcu / 15min
}
