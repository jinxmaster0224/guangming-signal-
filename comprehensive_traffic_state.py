...
TARGET_DATE_WD = '2026-03-25'
DAY_TYPE_WD = '工作日'

TARGET_DATE_WE = '2026-03-22'
DAY_TYPE_WE = '非工作日'

INTERSECTION = '光明大道与华夏路'
...
# ================= 核心路口名称与ID映射字典 =================
# 左侧是系统导出的 inter_id，右侧是标准的中文路口名
# 当您修改顶部的 INTERSECTION 时，必须严格使用右侧的中文名称
INTER_ID_NAME_MAP = {
...
CURRENT_SIGNAL_PLAN_WEEKDAY = {
    '现行周期方案': [
        {'start': '00:00', 'end': '06:00', 'scheme': '方案1', 'cycle': 108, 'phase_times': {'北向全放': 30, '南向全放': 30, '东向全放': 24, '西向全放': 24}},
        {'start': '06:00', 'end': '07:15', 'scheme': '方案2', 'cycle': 140, 'phase_times': {'北向全放': 43, '南向全放': 42, '东向全放': 28, '西向全放': 27}},
        {'start': '07:15', 'end': '08:45', 'scheme': '方案3', 'cycle': 163, 'phase_times': {'北向全放': 49, '南向全放': 49, '东向全放': 33, '西向全放': 32}},
        {'start': '08:45', 'end': '12:00', 'scheme': '方案4', 'cycle': 155, 'phase_times': {'北向全放': 45, '南向全放': 45, '东向全放': 33, '西向全放': 32}},
        {'start': '12:00', 'end': '14:00', 'scheme': '方案5', 'cycle': 155, 'phase_times': {'北向全放': 45, '南向全放': 45, '东向全放': 33, '西向全放': 32}},
        {'start': '14:00', 'end': '16:30', 'scheme': '方案6', 'cycle': 155, 'phase_times': {'北向全放': 45, '南向全放': 45, '东向全放': 33, '西向全放': 32}},
        {'start': '16:30', 'end': '19:00', 'scheme': '方案3', 'cycle': 163, 'phase_times': {'北向全放': 49, '南向全放': 49, '东向全放': 33, '西向全放': 32}},
        {'start': '19:00', 'end': '21:00', 'scheme': '方案7', 'cycle': 155, 'phase_times': {'北向全放': 45, '南向全放': 45, '东向全放': 33, '西向全放': 32}},
        {'start': '21:00', 'end': '22:30', 'scheme': '方案2', 'cycle': 140, 'phase_times': {'北向全放': 43, '南向全放': 42, '东向全放': 28, '西向全放': 27}},
        {'start': '22:30', 'end': '23:59', 'scheme': '方案2', 'cycle': 140, 'phase_times': {'北向全放': 43, '南向全放': 42, '东向全放': 28, '西向全放': 27}},
    ],
...
CURRENT_SIGNAL_PLAN_WEEKEND = {
    '现行周期方案': [
        {'start': '00:00', 'end': '06:00', 'scheme': '方案8', 'cycle': 108, 'phase_times': {'北向全放': 30, '南向全放': 30, '东向全放': 24, '西向全放': 24}},
        {'start': '06:00', 'end': '07:15', 'scheme': '方案9', 'cycle': 140, 'phase_times': {'北向全放': 43, '南向全放': 42, '东向全放': 28, '西向全放': 27}},
        {'start': '07:15', 'end': '08:45', 'scheme': '方案10', 'cycle': 163, 'phase_times': {'北向全放': 49, '南向全放': 49, '东向全放': 33, '西向全放': 32}},
        {'start': '08:45', 'end': '12:00', 'scheme': '方案11', 'cycle': 155, 'phase_times': {'北向全放': 45, '南向全放': 45, '东向全放': 33, '西向全放': 32}},
        {'start': '12:00', 'end': '14:00', 'scheme': '方案12', 'cycle': 155, 'phase_times': {'北向全放': 45, '南向全放': 45, '东向全放': 33, '西向全放': 32}},
        {'start': '14:00', 'end': '17:00', 'scheme': '方案13', 'cycle': 155, 'phase_times': {'北向全放': 45, '南向全放': 45, '东向全放': 33, '西向全放': 32}},
        {'start': '17:00', 'end': '19:00', 'scheme': '方案14', 'cycle': 163, 'phase_times': {'北向全放': 49, '南向全放': 49, '东向全放': 33, '西向全放': 32}},
        {'start': '19:00', 'end': '21:00', 'scheme': '方案15', 'cycle': 155, 'phase_times': {'北向全放': 45, '南向全放': 45, '东向全放': 33, '西向全放': 32}},
        {'start': '21:00', 'end': '22:30', 'scheme': '方案16', 'cycle': 140, 'phase_times': {'北向全放': 43, '南向全放': 42, '东向全放': 28, '西向全放': 27}},
        {'start': '22:30', 'end': '23:59', 'scheme': '方案17', 'cycle': 131, 'phase_times': {'北向全放': 38, '南向全放': 38, '东向全放': 28, '西向全放': 27}},
    ],
    '相位损失时间': {'北向全放': 9, '南向全放': 9, '东向全放': 7, '西向全放': 7},
    '专属相位映射': {
        '相位1(北向全放)': [('北向', '直行'), ('北向', '左转')],
...
# ================= 路口偏移角配置 =================
# 这里的键也必须与 INTER_ID_NAME_MAP 中的中文名称完全一致
INTER_OFFSET_MAP = {
    '光明大道与光辉大道': 0.0, 
    '光明大道与光明大街': -32.57, 
    '光明大道与光安路': -33.69,
...
for i_id, i_name in INTER_ID_NAME_MAP.items():
    ...
    INTER_CONFIG[i_id] = {
        "name": i_name, "offset": INTER_OFFSET_MAP.get(i_name, 0.0),
...
# ================= Phase 1: 数据合并与清洗 =================
def analyze_multiple_files(file_paths, output_dir):
    date_ranges = [
        (pd.Timestamp(f'{TARGET_DATE_WD} 00:00:00'), pd.Timestamp(f'{TARGET_DATE_WD} 23:59:59')),
        (pd.Timestamp(f'{TARGET_DATE_WE} 00:00:00'), pd.Timestamp(f'{TARGET_DATE_WE} 23:59:59'))
    ]
    ...
    for file_path in file_paths:
        ...
        if current_inter_id not in INTER_CONFIG: continue
        ...
        export_cols = ['路口名称', '进口道方向', '转向', 'create_time', '延误指数', 'pass_flow', '历史最大分均流量', '流量占比(%)', 'queue_len_avg', 'queue_len_max']
        for c in export_cols: 
            if c not in df_export.columns: df_export[c] = None
        
        df_final = df_export[export_cols].rename(columns={
            'pass_flow': '5分钟车流量', '历史最大分均流量': '历史最大5分钟流量', 
            'queue_len_avg': '平均排队长度', 'queue_len_max': '最大排队长度'
        })
...
def run_tod_partition(file_paths, output_dir):
    ...
    for day_type, target_date in [(DAY_TYPE_WD, TARGET_DATE_WD), (DAY_TYPE_WE, TARGET_DATE_WE)]:
        ...
        for file_path in file_paths:
            ...
            df = df[df['create_time'].dt.normalize() == target_timestamp].copy()
            if df.empty: continue
                
            time_offsets = df['create_time'] - df['create_time'].dt.normalize()
            df['_temp_time'] = pd.Timestamp('2026-01-01') + time_offsets
            
            df = enrich_direction_features(df, offset_degree=offset)
            if 'turn_dir_no' in df.columns: df = df[df['turn_dir_no'].isin([1, 2])].copy()
            else: continue
            ...
            df['5分钟车流量'] = pd.to_numeric(df[p_col].astype(str).str.replace(',', '', regex=False).str.extract(r'(\d+\.?\d*)')[0], errors='coerce').fillna(0) if p_col else 0
...
def run_period_analysis(df_path, time_periods, output_dir, current_plan, day_type, target_date):
    ...
    df = df[df['路口名称'] == INTERSECTION].copy()
    ...
    for p in time_periods:
        ...
        pdf = df[df['true_start_time'].dt.strftime('%H:%M').isin(time_strs)].copy()
        ...
        results.append({
            ...
            'avg_flow': p['avg_flow'], 'max_queue': p['max_queue'],
        ...
        print(f"  流量状态: {st}")
        print(f"  平均流量: {p['avg_flow']} pcu/15min | 最大排队: {p['max_queue']}m")
...
if __name__ == "__main__":
    ...
    if not csv_files:
        ...
        processed_data_path = analyze_multiple_files(csv_files, target_dir)
        
        if processed_data_path:
            # 👇 修改点：动态提取实际生成的明细表文件名 👇
            generated_files.append(("底层聚合清洗数据明细表", os.path.basename(processed_data_path), processed_data_path))
            
            dynamic_periods_dict, periods_path = run_tod_partition(csv_files, target_dir)
            
            if dynamic_periods_dict[DAY_TYPE_WD] and dynamic_periods_dict[DAY_TYPE_WE]:
                # 👇 修改点：动态提取实际生成的划分结果表文件名 👇
                generated_files.append(("Fisher肘部时段划分结果", os.path.basename(periods_path), periods_path))
                
                wd_name, wd_path = run_period_analysis(
                    processed_data_path, dynamic_periods_dict[DAY_TYPE_WD], target_dir, 
                    current_plan=CURRENT_SIGNAL_PLAN_WEEKDAY, day_type=DAY_TYPE_WD, target_date=TARGET_DATE_WD
                )
                generated_files.append(("工作日信控推演方案结果", wd_name, wd_path))
                
                we_name, we_path = run_period_analysis(
                    processed_data_path, dynamic_periods_dict[DAY_TYPE_WE], target_dir, 
                    current_plan=CURRENT_SIGNAL_PLAN_WEEKEND, day_type=DAY_TYPE_WE, target_date=TARGET_DATE_WE
                )
